...
public class Choice4FragMent extends Fragment implements View.OnClickListener {
    ...
    void changeFragment(){
        ...
        fragmentTransaction.replace(R.id.fragmentLayout , new Choice5FragMent());
