...
public class Choice7FragMent extends Fragment implements View.OnClickListener {
    ...
    void changeFragment(){
        ...
        fragmentTransaction.replace(R.id.fragmentLayout , new Choice8FragMent());
