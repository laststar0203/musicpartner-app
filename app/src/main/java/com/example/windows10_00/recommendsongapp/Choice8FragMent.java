...
public class Choice8FragMent extends Fragment implements View.OnClickListener {
    ...
    void changeFragment(){
        ...
        fragmentTransaction.replace(R.id.fragmentLayout , new Choice9FragMent());
