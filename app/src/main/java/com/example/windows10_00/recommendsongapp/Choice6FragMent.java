...
public class Choice6FragMent extends Fragment implements View.OnClickListener {
    ...
    void changeFragment(){
        ...
        fragmentTransaction.replace(R.id.fragmentLayout , new Choice7FragMent());
