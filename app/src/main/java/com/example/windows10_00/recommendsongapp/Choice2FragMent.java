...
public class Choice2FragMent extends Fragment implements View.OnClickListener {
    ...
    void changeFragment(){
        ...
        fragmentTransaction.replace(R.id.fragmentLayout , new Choice3FragMent());
