...
public class Choice9FragMent extends Fragment implements View.OnClickListener {
    ...
    public View onCreateView(@NonNull LayoutInflater inflater, @Nullable ViewGroup container, @Nullable Bundle savedInstanceState) {
         ...
         rootView = inflater.inflate(R.layout.choice9 , container , false);
         setUp(rootView);
    ...
    void changeFragment(){
        ...
        fragmentTransaction.replace(R.id.fragmentLayout , new Choice10FragMent());
